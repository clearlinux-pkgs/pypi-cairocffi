...
Source0  : https://files.pythonhosted.org/packages/ba/94/372aaeb17dce40a646e5a2df61d10e43a20b6d3021deeab8280eba748077/cairocffi-1.7.0.tar.gz
...
%prep
%setup -q -n cairocffi-1.7.0
cd %{_builddir}/cairocffi-1.7.0
pushd ..
cp -a cairocffi-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714323051
